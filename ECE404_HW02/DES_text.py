...
if __name__ ==  '__main__':
    ...
    print(round_keys)
    print('\n')
    encrypt(file_to_encrypt, round_keys, output_encrypted)

    print("decrypting file reversed keys: \n")
    #reversed = round_keys.reverse()
    reversed = round_keys[::-1]
    print(reversed)
    encrypt(output_encrypted, reversed, output_decrypted)
